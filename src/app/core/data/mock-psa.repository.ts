...
export class MockPsaRepository {
  readonly faultTree = signal<FaultTreeModel>({
    ...
    nodes: [
      ...
      { key: 'PTR101PO-FS', category: 'BASIC_EVENT', id: 'PTR101PO-FS', description: 'PTR train A pump fails to start', state: 'NORMAL', reliabilityModel: 3, recordType: 'BEV' },
      { key: 'PTR201PO-FS', category: 'BASIC_EVENT', id: 'PTR201PO-FS', description: 'PTR train B pump fails to start', state: 'NORMAL', reliabilityModel: 3, recordType: 'BEV' },
      { key: 'DG1-FS', category: 'BASIC_EVENT', id: 'DG1-FS', description: 'Diesel generator 1 fails to start', state: 'NORMAL', reliabilityModel: 3, recordType: 'BEV' },
      { key: 'DG2-FS', category: 'BASIC_EVENT', id: 'DG2-FS', description: 'Diesel generator 2 fails to start', state: 'NORMAL', reliabilityModel: 3, recordType: 'BEV' },
      { key: 'MAKEUP-01', category: 'BASIC_EVENT', id: 'MAKEUP-01', description: 'Make-up path 1 unavailable', state: 'NORMAL', reliabilityModel: 1, recordType: 'BEV' },
      { key: 'MAKEUP-02', category: 'BASIC_EVENT', id: 'MAKEUP-02', description: 'Make-up path 2 unavailable', state: 'NORMAL', reliabilityModel: 1, recordType: 'BEV' },
      { key: 'MAKEUP-03', category: 'BASIC_EVENT', id: 'MAKEUP-03', description: 'Make-up path 3 unavailable', state: 'NORMAL', reliabilityModel: 1, recordType: 'BEV' },
